...
<table id="content-boardList">
        ...
        <tr> 
           ...
           <form id="searchFm" action='<c:url value="/admin/adminList.do"/>'  method="post" >
            ...
            <td colspan="4"><input type="text" placeholder="검색어를 입력해주세요." id="searchTitle"  name="searchTitle"  value="${result.board.searchTitle}"></td>
